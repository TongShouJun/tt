 ...
 * fetched from a URL. һ���򵥵������ @ link
 * ImageResizer��ȡ���������С��ͼ���URL����ȡ��
 */
public class ImageFetcher extends ImageResizer {
    ...
    private Bitmap processBitmap(String data) {
        ...
        FileDescriptor fileDescriptor = null; // Descriptor ������
    ...
    public String getHttpCacheImagePath(String url) {
        final String key = ImageCache.hashKeyForDisk(url);
        String path = mHttpCacheDir.getAbsolutePath() + File.separator + key + ".0";
        File file = new File(path);
        if (file.exists()) {
            return path;
        }

        path = mImageCacheParams.diskCacheDir.getAbsolutePath() + File.separator + key + ".0";
        return path;
    }
