...
public class Lunar {
	...
	public final static String chineseNumber[] = { "一", "二", "三", "四", "五",
			"六", "七", "八", "九", "十", "十一", "十二" };
	...
	public String getHZMMDD() {
		return chineseNumber[month - 1] + "月" + getChinaDayString(day);
	}

	public String getHZMMDD2() {
		return "农历" + getHZMMDD();
	}

	public String getHZMM() {
	...
	public static void main(String[] args) throws ParseException {
		...
		today.setTime(chineseDateFormat.parse("2013年8月10日"));
